...
const RoomIcon = () => (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M20.14 8.71a2.01 2.01 0 0 0-1.85-.71H14V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v15H3v2h18v-2h-1v-5l.14-7.29zM12 21H6v-6h6v6zm0-8H6v-2h6v2zm0-4H6V6h6v3zm6 12h-4v-4h2v-2h-2v-4h4v10z" />
    </svg>
);
const BookingIcon = () => (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
        <path d="M19 4h-2V2h-2v2H9V2H7v2H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V10h14v10zM5 8V6h14v2H5zm2 5h4v4H7v-4z" />
    </svg>
);
const UserIcon = () => (
    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    return (
        <aside className="w-64 bg-white text-slate-700 flex flex-col h-screen sticky top-0 border-r border-slate-100 shadow-[4px_0_24px_rgba(0,0,0,0.02)]">
            <div className="h-24 flex items-center justify-center border-b border-slate-100">
                <Link
                    href="/admin"
                    className="outline-none hover:scale-105 transition-transform duration-200"
            ...
            <div className="p-6 border-t border-slate-100 space-y-2">
                <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 rounded-2xl text-red-500 hover:bg-red-50 hover:text-red-600 font-bold transition-colors"
                >
                    <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
