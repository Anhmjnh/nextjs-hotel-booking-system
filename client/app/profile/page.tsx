...
export default function ProfilePage() {
  ...
  const handleAvatarChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (!file.type.startsWith("image/")) {
      return toast.error("Vui lòng chọn một tệp hình ảnh hợp lệ!");
    }
    ...
    try {
      ...
      if (!cloudinaryData.secure_url) throw new Error("Lỗi khi tải ảnh lên Cloudinary");

      // 2. Gửi Link ảnh an toàn về Backend để lưu vào Database
      const token = Cookies.get("token");
      ...
      toast.error("Tải ảnh thất bại! Vui lòng kiểm tra lại cấu hình Cloudinary.", { id: loadingToast });
    } finally {
        ...
        <div className="max-w-[1100px] mx-auto px-8 xl:px-12">
          <div className="mb-14 text-center max-w-3xl mx-auto">
            ...
            <p className="text-lg text-slate-500 font-medium ">
              Quản lý thông tin tài khoản và các hoạt động đặt phòng của bạn.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 mb-10 pb-10 border-b border-slate-100">
                ...
                {!isEditing && (
                  <button
                    ...
                    className="px-6 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-700 font-bold rounded-full transition-colors duration-200 shadow-sm"
                  >
                    Chỉnh sửa hồ sơ
                  </button>
                )}
              ...
              <div className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-5 py-4 rounded-xl border border-slate-200 font-medium outline-none transition ${isEditing ? "bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-slate-900" : "bg-slate-50 text-slate-700 cursor-not-allowed"}`}
                  />
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      readOnly
                      value={user?.email || ""}
                      className="w-full px-5 py-4 rounded-xl border border-slate-200 bg-slate-50 text-slate-500 font-medium outline-none cursor-not-allowed"
                ...
                {isEditing && (
                  <div className="pt-6 flex items-center gap-4 justify-end">
                    ...
                    <button
                      ...
                      disabled={isSaving}
                      className="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-600/30 transition disabled:bg-blue-400 disabled:shadow-none flex items-center gap-2"
                    >
                      {isSaving ? (
            ...
            <div className="space-y-6">
              ...
              <Link
                href="/dashboard"
                className="block bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:shadow-xl hover:shadow-blue-500/10 hover:border-blue-200 transition-all duration-300 group cursor-pointer"
              >
                ...
                <p className="text-slate-500 font-medium text-sm leading-relaxed">
                  Xem lại các chuyến đi, theo dõi trạng thái và quản lý đơn đặt
                  phòng của bạn.
                </p>
              </Link>
                ...
                {!isChangingPassword ? (
                  <>
                    ...
                    <button
                      ...
                      className="text-blue-600 font-bold hover:text-blue-700 hover:underline outline-none"
                    >
                      Đổi mật khẩu &rarr;
                    </button>
                  </>
                  ...
                  <div className="space-y-4 mt-2">
                    <div className="relative">
                      <input
                        ...
                        className="w-full pl-4 pr-12 py-3 rounded-xl border border-slate-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 outline-none transition text-sm font-medium"
                      />
                      <button
                        type="button"
                    ...
                    <div className="flex items-center gap-3 pt-2">
                      ...
                      <button
                        ...
                        className="flex-1 py-2.5 bg-blue-600 text-white font-bold rounded-xl hover:bg-blue-700 transition disabled:opacity-50 disabled:cursor-not-allowed flex justify-center items-center"
                      >
                        {isSavingPassword ? (
                          <div className="w-5 h-5 border-2 border-white/30 border-t-white rounded-full animate-spin"></div>
                        ) : (
